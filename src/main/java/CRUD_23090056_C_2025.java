 ...
 */
package com.mycompany.P_UTS_23090056_C__2025;
 ...
 * @author mfaiz
 */
public class CRUD_23090056_C_2025 {
    public static void main(String[] args) {
        String URL = "mongodb://localhost:27017";

        try (MongoClient mongo = MongoClients.create(URL)) {
            MongoDatabase DB = mongo.getDatabase("UTS_23090056_C_2025");
            MongoCollection<Document> collection = DB.getCollection("UTS_23090056_C_2025");

            // CREATE
            Document product = new Document("NIM", "23090084")
                    .append("KELAS", "C")
                    .append("TAHUN", "2025")
            ...
            Bson filter = Filters.eq("NIM", "23090084");
